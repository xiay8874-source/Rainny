...
export const dict = {
  ...
  "dialog.plugins.empty": "在 rainny.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (rainny.json) 中的 provider/model 名称",
  ...
  "session.files.view.source": "源码",
  "session.files.view.preview": "预览",
  ...
  "session.header.open.copyContent": "复制文件内容",
