...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler rainny.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (rainny.json) sağlayıcı/model adlarını kontrol edin",
  ...
  "app.name.desktop": "Rainny Masaüstü",
