export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en rainny.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (rainny.json)",
