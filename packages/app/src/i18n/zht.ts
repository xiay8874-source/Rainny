...
export const dict = {
  ...
  "dialog.plugins.empty": "在 rainny.json 中設定的外掛程式",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (rainny.json) 中的 provider/model 名稱",
  ...
  "session.files.view.source": "原始碼",
  "session.files.view.preview": "預覽",
  ...
  "session.header.open.copyContent": "複製檔案內容",
