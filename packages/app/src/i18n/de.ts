...
export const dict = {
  ...
  "dialog.plugins.empty": "In rainny.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (rainny.json) auf Anbieter-/Modellnamen",
