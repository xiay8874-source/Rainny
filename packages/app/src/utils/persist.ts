...
const GLOBAL_STORAGE = "rainny.global.dat"
const WINDOW_STORAGE = "rainny.window"
const LOCAL_PREFIX = "rainny."
...
function workspaceStorage(dir: string) {
  ...
  return `rainny.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `rainny.draft.${head}.${sum}.dat`
}
