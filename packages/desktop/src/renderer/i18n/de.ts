export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Rainny",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Rainny wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'rainny' zu verwenden.",
