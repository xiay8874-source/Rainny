export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Rainny",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Rainny. ¿Quieres instalarla y reiniciar?",
