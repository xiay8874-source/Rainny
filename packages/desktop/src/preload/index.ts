...
const api: ElectronAPI = {
  ...
  openCodeReference: (request) => ipcRenderer.invoke("open-code-reference", request),
  resolveCodeReference: (request) => ipcRenderer.invoke("resolve-code-reference", request),
  readLocalFile: (request) => ipcRenderer.invoke("read-local-file", request),
  getDefaultApplication: (request) => ipcRenderer.invoke("get-default-application", request),
